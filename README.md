...
This repo implements a framework which allows building PyTorch neural networks from YAML configuration files. Avoiding to create tedious architectures using nn.Sequential, you can just define your architectures as a yaml file (check examples in ./models/). Inspired by YOLOv5.
